...
import yte.intern.springweb.RestTemplateExample.Comment;
import yte.intern.springweb.RestTemplateExample.Post;
...
public class RestTemplateTest {
    ...
    void UpdateComment(){
            ...
            URI uri=fromHttpUrl(BASE_URL)
                    ...
                    .build()
                    .toUri();
        RequestEntity<Comment> request = RequestEntity.put(uri).body(new Comment(9L, 5L, "hebele", "hübele@hibele.com", "hello!"));
